...
/**
 * deltaPut Calulates the change in the price of a Put as the stock price changes
...
/**
 * deltaCall Calulates the change in the price of a Call as the stock price changes.
 * Think of it as the potential velocity of change in price.
 *
 * @method deltaCall
 * @param {Number} S the current stock price
...
/**
 * gammaPut Calulates the change in the price of a Put as the square change in stock price.
...
/**
 * gammaCall Calulates the change in the price of a Put as the square change in stock price.
...
/**
 * vegaPut Calulates the change in the price of a Put as the change in volatility.
...
/**
 * vegaCall Calulates the change in the price of a Call as the change in volatility.
 * This measures the change in the option price as the variability in the prices in the market increase.
 *
 * @method vegaCall
 * @param {Number} S the current stock price
...
/**
 * rhoPut Calulates the change in the price of a option as the interest rate changes.
 *
 * @method rhoPut
 * @param {Number} S the current stock price
 * @param {Number} X the strike price
...
/**
 * rhoCall Calulates the change in the price of the option as the interest rate changes.
 *
 * @method rhoCall
 * @param {Number} S the current stock price
 * @param {Number} X the strike price
...
/**
 * thetaPut Calulates the change in option price as we approach expiration.
 *
 *
 * @method thetaPut
 * @param {Number} S the current stock price
...
/**
 * thetaCall Calulates the change in option price as we approach expiration.
 *
 *
 * @method thetaCall
 * @param {Number} S the current stock price
